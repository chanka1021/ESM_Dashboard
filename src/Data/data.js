...
export function Turnover_KPI() {
  ...
  useEffect(() => {
      axios.get("http://localhost:5137/Turnover_KPI").then((response) => {
...
export function Forcast_hist() {
  ...
  useEffect(() => {
      ...
      axios.get("http://localhost:5137/forcast_hist").then((response) => {
...
export function Wareh_KPI_IN() {
  ...
  useEffect(() => {
    axios.get("http://localhost:5137/wareh_kpi_in").then((response) => {
...
export function KPI_FORCAST() {
  ...
  useEffect(() => {
    axios.get("http://localhost:5137/KPI_FORCAST").then((response) => {
...
export function Budget_TO() {
  ...
  useEffect(() => {
    axios.get("http://localhost:5137/budget_TO").then((response) => {
...
export function Working_Mach() {
  ...
  useEffect(() => {
    axios.get("http://localhost:5137/Working_Mach").then((response) => {
...
export function Kpi_Data_Prod() {
  ...
  useEffect(() => {
    axios.get("http://localhost:5137/kpi_data_prod").then((response) => {
...
export function Kpi_wip() {
  ...
  useEffect(() => {
    axios.get("http://localhost:5137/kpi_wip").then((response) => {
...
export function Forcast_hist_today(date) {
  ...
  useEffect(() => {
      ...
      axios.get("http://localhost:5137/forcast_hist/"+date).then((response) => {
        setForcast_hist((existingData) => {
        return response.data;
      });
    });
...
export function Turnover_KPI_today(date) {
  ...
  useEffect(() => {
      axios.get("http://localhost:5137/Turnover_KPI/date/"+date).then((response) => {
        setTurnover_kpi((existingData) => {
          return response.data;
        });
      });
...
export function Wareh_KPI_IN_WEEK(week) {
  const [wareh_kpi_in, setWareh_kpi_in] = useState([{}]);
  useEffect(() => {
    axios.get("http://localhost:5137/wareh_kpi_in/week/"+week).then((response) => {
      setWareh_kpi_in((existingData) => {
        return response.data;
      });
    });
...
export function Turnover_KPI_month(month) {
  ...
  useEffect(() => {
      axios.get("http://localhost:5137/Turnover_KPI/month/"+month).then((response) => {
        setTurnover_kpi((existingData) => {
          return response.data;
        });
      });
...
export function Wareh_KPI_IN_month(month) {
  const [wareh_kpi_in, setWareh_kpi_in] = useState([{}]);
  useEffect(() => {
    axios.get("http://localhost:5137/wareh_kpi_in/month/"+month).then((response) => {
      setWareh_kpi_in((existingData) => {
        return response.data;
      });
    });
...
export function Working_Mach_day(date) {
  const [working_mach, setWorking_mach] = useState([{}]);
  useEffect(() => {
    axios.get("http://localhost:5137/Working_Mach/date/"+date).then((response) => {
      setWorking_mach((existingData) => {
        return response.data;
      });
    });
...
export function Kpi_Data_Prod_day(date) {
  const [kpi_data_prod, setKpi_data_prod] = useState([{}]);
  useEffect(() => {
    axios.get("http://localhost:5137/kpi_data_prod/date/"+date).then((response) => {
      setKpi_data_prod((existingData) => {
        return response.data;
      });
    });
...
export function Wareh_KPI_IN_day(date) {
  const [wareh_kpi_in, setWareh_kpi_in] = useState([{}]);
  useEffect(() => {
    axios.get("http://localhost:5137/wareh_kpi_in/date/"+date).then((response) => {
      setWareh_kpi_in((existingData) => {
        return response.data;
      });
    });
...
export function Kpi_Data_Prod_week(week) {
  const [kpi_data_prod, setKpi_data_prod] = useState([{}]);
  useEffect(() => {
    axios.get("http://localhost:5137/kpi_data_prod/week/"+week).then((response) => {
      setKpi_data_prod((existingData) => {
        return response.data;
      });
    });
...
export function Monthly_To_Wi() {
  const [kpi_data_prod, setKpi_data_prod] = useState([{}]);
  useEffect(() => {
    axios.get("http://localhost:5137/MonthlyToWi").then((response) => {
      setKpi_data_prod((existingData) => {
        return response.data;
      });
    });
